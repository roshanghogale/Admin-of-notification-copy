...
function NewsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('titleDescription', titleDescription.trim());
      ...
      <Card elevation={3} className="form-card">
        <CardContent sx={{ p: 4 }}>
          ...
          <Grid container spacing={3}>
            ...
            {/* Title Description and Sub Title */}
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                ...
                <Grid item xs={12} md={4}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onChange={(e) => setBachelorDegrees(e.target.value)}
                ...
                <Grid item xs={12} md={4}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onChange={(e) => setMastersDegrees(e.target.value)}
            ...
            {/* Checkboxes, Submit Button, and Image Upload Row */}
            <Grid item xs={12} md={3}>
              <Paper elevation={2} sx={{ p: 2, borderRadius: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <FormControlLabel
                  control={
                    <Checkbox
