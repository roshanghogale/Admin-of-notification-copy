...
function StoryPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('otherType', isMainStory ? otherType : '');
      formData.append('isMainStory', isMainStory);
      formData.append('educationCategories', JSON.stringify(isMainStory && otherType === 'education' ? educationCategories : []));
      formData.append('bachelorDegrees', JSON.stringify(isMainStory && otherType === 'education' && !educationCategories.includes("All") ? bachelorDegrees : []));
      ...
      <Card elevation={3} className="form-card">
        <CardContent sx={{ p: 4 }}>
          ...
          <Grid container spacing={3}>
            ...
            {isMainStory && otherType === "education" && (
              <>
                <Grid item xs={12} md={4}>
                  <FormControl fullWidth>
            ...
            {isMainStory && otherType === "location" && (
              <>
            ...
            {isMainStory && otherType === "age group" && (
